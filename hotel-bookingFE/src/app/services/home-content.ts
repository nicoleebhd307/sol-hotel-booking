...
export class HomeContent {
  getHomePageData(): HomePageData {
    return {
      ...
      bookingCta: {
        backgroundImageUrl:
          'https://images.unsplash.com/photo-1610641818989-c2051b5e2cfd?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
