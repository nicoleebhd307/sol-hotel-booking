...
export class BookingRowComponent implements OnChanges {
  ...
  private getAllowedNextStatuses(status: BookingStatus, role: BookingRole): BookingStatus[] {
    // Pending bookings are no longer managed here (they auto-expire after 30 min).
    // Only active/paid bookings (Confirmed, Checked In, Checked Out) appear in this view.
